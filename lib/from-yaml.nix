# TODO yaml2nix has better output? eg. "^_" or "\x1F" in a string
# https://github.com/cdepillabout/stacklock2nix/blob/main/nix/build-support/stacklock2nix/read-yaml.nix
# Copyright (c) 2022 Dennis Gosnell https://github.com/cdepillabout/stacklock2nix/blob/main/LICENSE
{
  lib,
  remarshal,
  runCommand,
